Title: Listing 8.7 - Normal timer/counter mode.
...
Purpose: Uses Timer/counter 2 to toggle LEDs on D11 and D3. D11
         ...
         itself handles the flashing of the two LEDs.

         In a proper sketch, where the loop() was doing work, the use of the timer to
         toggle a pair of pins, independently of the main CPU, can be very useful. The 
         timer hardware does the toggling here but, we are restricted to pins D11 and D3
         - we have no choice in the matter - they are the timer's pins.
